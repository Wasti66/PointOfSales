<!-- current password -->
                <div class="mb-4">
                    ...
                    <input type="password" name="current_pass" id="current_password" class="form-control border border-secondary custom-input poppins-medium" placeholder="Password">
                ...
                <div class="mb-4">
                    ...
                    <input type="password" name="new_password" id="new_password" class="form-control border border-secondary custom-input poppins-medium" placeholder="Password">
                ...
                <div class="mb-4">
                    ...
                    <input type="password" name="confirm_password" id="confirm_password" class="form-control border border-secondary custom-input poppins-medium" placeholder="Password">
